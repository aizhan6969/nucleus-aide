...
export function GoogleButton({
  ...
  return (
    <button
      ...
      onClick={onClick}
      disabled={loading}
      className="flex h-10 w-full items-center justify-center gap-2.5 rounded-md bg-white text-sm font-medium text-[#1f1f1f] transition hover:bg-white/90 disabled:opacity-60"
    >
      {loading ? (
        ...
        <svg className="h-4 w-4" viewBox="0 0 48 48" aria-hidden>
          ...
          <path fill="#1976D2" d="M43.6 20.5H42V20H24v8h11.3c-.8 2.3-2.3 4.3-4.1 5.7l6.2 5.2C41.5 35.7 44 30.3 44 24c0-1.2-.1-2.4-.4-3.5z"/>
        </svg>
      )}
      {label}
    </button>
